...
public class GdpEdizione extends PanacheEntityBase {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gdp_edizione")
    @SequenceGenerator(name = "seq_gdp_edizione", sequenceName = "seq_gdp_edizione", allocationSize = 1)

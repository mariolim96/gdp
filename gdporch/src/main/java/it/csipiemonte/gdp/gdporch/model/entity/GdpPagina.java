...
public class GdpPagina extends PanacheEntityBase {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_gdp_pagina")
    @SequenceGenerator(name = "seq_gdp_pagina", sequenceName = "seq_gdp_pagina", allocationSize = 1)

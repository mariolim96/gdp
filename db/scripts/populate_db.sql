...
INSERT INTO GDP_LOG_EDIZIONE (ID_GDP_LOG_EDIZIONE, FK_GDP_LOG, NRO_PAG_ACQUISITE, TIPO_EDIZIONE, FK_GDP_EDIZIONE, PATH_EDIZIONE, NRO_PAG_VALIDE, NRO_PAG_ERRATE, STATO) VALUES
(1, 1, 24, 'OK', 1, '/edizioni/gazzetta/oggi/', 24, 0, 'COMPLETED'),
(2, 2, 16, 'OK', 3, '/edizioni/corriere/oggi/', 16, 0, 'COMPLETED'),
(3, 3, 8, 'AA', 4, '/edizioni/cuneo/oggi/', 7, 1, 'FAILED');
...
INSERT INTO GDP_LOG_EDIZIONE (ID_GDP_LOG_EDIZIONE, FK_GDP_LOG, NRO_PAG_ACQUISITE, TIPO_EDIZIONE, FK_GDP_EDIZIONE, PATH_EDIZIONE, NRO_PAG_VALIDE, NRO_PAG_ERRATE, STATO) VALUES
(4, 4, 12, 'ST', 6, '/edizioni/novara_lavoro/storico/2005/', 12, 0, 'COMPLETED');
